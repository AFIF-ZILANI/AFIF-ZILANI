...
<p align="center">
  <strong>Entrepreneur • Full‑Stack Developer • Tech‑for‑Good Advocate</strong><br/>
  From Naogaon, Bangladesh — crafting scalable AI & Web solutions that uplift communities.
</p>
...
- **Full Stack Web Development**: Building responsive, performant, and scalable web applications using modern frameworks and best practices.
- **UI & UX Design**: Crafting intuitive user interfaces and seamless experiences with attention to accessibility and aesthetics.
- **System Design**: Architecting robust, distributed systems and designing microservices, APIs, and scalable architectures.
- **Database Management**: Designing, implementing, and optimizing relational and NoSQL databases for reliability and performance.
- **Low-Level Programming (Rust)**: Writing safe, efficient, and concurrent systems-level code in Rust.
- **Prompt Engineering**: Designing effective prompts and workflows to harness the power of AI models for diverse applications.

---

## 🗣️ Languages
<div align="center">
  <img align="left" alt="Rust"        src="https://img.shields.io/badge/Rust-000000?logo=rust&logoColor=white&style=for-the-badge" />
  ...
  <img align="left" alt="SQL"         src="https://img.shields.io/badge/SQL-003B57?logo=postgresql&logoColor=white&style=for-the-badge" />
  <img align="left" alt="Markdown"    src="https://img.shields.io/badge/Markdown-000000?logo=markdown&logoColor=white&style=for-the-badge" />
</div>
<br clear="both"/>
...
## 🛠️ Tools
<div align="center">
  <img align="left" alt="Linux"      src="https://img.shields.io/badge/Linux-FCC624?logo=linux&logoColor=black&style=for-the-badge" />
  <img align="left" alt="Docker"     src="https://img.shields.io/badge/Docker-2496ED?logo=docker&logoColor=white&style=for-the-badge" />
  <img align="left" alt="Kubernetes" src="https://img.shields.io/badge/Kubernetes-326CE5?logo=kubernetes&logoColor=white&style=for-the-badge" />
...
> “Code is poetry, but code that helps people is a legacy.”  
> — AFIF ZILANI
